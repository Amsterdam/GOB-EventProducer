...
from gobcore.message_broker.config import EVENT_PRODUCE, EVENT_PRODUCE_QUEUE, EVENT_PRODUCE_RESULT_KEY, \
    WORKFLOW_EXCHANGE
...
from gobeventproducer.database.connection import connect
